...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const isPublic = pathname?.startsWith('/inv/') || pathname?.startsWith('/sign-in') || pathname?.startsWith('/sign-up') || pathname?.startsWith('/terms-of-service') || pathname?.startsWith('/privacy-policy');
