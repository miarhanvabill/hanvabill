...
const miscellaneousSections = [
  ...
  {
    title: "Invoices",
    description: "Manage, track, and send GST-compliant invoices to customers.",
    icon: FileText,
    href: "/invoices",
    color: "bg-blue-50 text-blue-600",
  },
  {
    title: "Expenses",
    description: "Track and categorize salon business expenses.",
    icon: FileText,
    href: "/expenses",
    color: "bg-red-50 text-red-600",
  },
  {
    title: "Enquiries",
    description: "Manage prospective customer leads and enquiries.",
    icon: Users,
    href: "/enquiry",
    color: "bg-purple-50 text-purple-600",
  },
  {
    title: "Appointments (Alternative)",
    description: "View and manage appointments in an alternative list format.",
    icon: Calendar,
    href: "/appointments",
    color: "bg-teal-50 text-teal-600",
  },
  {
    title: "To-Dos & Tasks",
    description: "Keep track of daily tasks and internal reminders.",
    icon: CheckCircle,
    href: "/todos",
    color: "bg-green-50 text-green-600",
  },
  {
    ...
    description: "Access training materials, help guides, and software documentation.",
    icon: Users,
    href: "/university",
    color: "bg-orange-50 text-orange-600",
  },
